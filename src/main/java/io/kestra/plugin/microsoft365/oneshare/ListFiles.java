...
public class ListFiles extends AbstractOneShareTask implements RunnableTask<ListFiles.Output> {
    ...
    public Output run(RunContext runContext) throws Exception {
        ...
        java.util.List<com.microsoft.graph.models.DriveItem> allItems = new ArrayList<>();
    ...
    private DriveItemCollectionResponse fetchNextPage(GraphServiceClient client, String nextLink) throws Exception {
        ...
        com.microsoft.graph.drives.item.items.item.children.ChildrenRequestBuilder builder = 
            new com.microsoft.graph.drives.item.items.item.children.ChildrenRequestBuilder(nextLink, client.getRequestAdapter());
        return builder.get();
    }
