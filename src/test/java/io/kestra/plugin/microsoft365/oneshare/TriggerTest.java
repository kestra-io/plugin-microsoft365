...
class TriggerTest extends AbstractOneShareTest {
    ...
    void listenFromFlow() throws Exception {
        ...
        try (
            ...
            java.util.List<Object> files = (java.util.List<Object>) last.get().getTrigger().getVariables().get("files");
    ...
    void shouldDetectNewFile() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        java.util.List<OneShareFile> files = (java.util.List<OneShareFile>) execution.get().getTrigger().getVariables().get("files");
    ...
    void shouldPersistStateAcrossEvaluations() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        java.util.List<OneShareFile> files1 = (java.util.List<OneShareFile>) execution1.get().getTrigger().getVariables().get("files");
        ...
        @SuppressWarnings("unchecked")
        java.util.List<OneShareFile> files3 = (java.util.List<OneShareFile>) execution3.get().getTrigger().getVariables().get("files");
